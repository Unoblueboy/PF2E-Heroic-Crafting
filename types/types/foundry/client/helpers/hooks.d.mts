import { DialogV2 } from '../applications/api/_module.mjs';
import { CombatTrackerConfig } from '../applications/apps/_module.mjs';
import { default as SettingsConfig } from '../applications/settings/config.mjs';
import { ContextMenuEntry } from '../applications/ux/context-menu.mjs';
import { default as Canvas } from '../canvas/board.mjs';
import { default as LightingLayer } from '../canvas/layers/lighting.mjs';
import { default as Token } from '../canvas/placeables/token.mjs';
import { Actor, Combat, Item, JournalEntry, JournalEntryPage, Macro, Scene, TokenDocument, User } from '../documents/_module.mjs';
...
import { default as ApplicationV2 } from '../applications/api/application.mjs';
import { default as TokenHUD } from '../applications/hud/token-hud.mjs';
import { ChatLog, CompendiumDirectory, ItemDirectory } from '../applications/sidebar/tabs/_module.mjs';
import { default as ActorDirectory } from '../applications/sidebar/tabs/actor-directory.mjs';
import { default as Hotbar } from '../applications/ui/hotbar.mjs';
import { default as SceneControls, SceneControl } from '../applications/ui/scene-controls.mjs';
import { default as Application } from '../appv1/api/application-v1.mjs';
import { default as Dialog } from '../appv1/api/dialog-v1.mjs';
